  ...
  const data = [
    {
      ...
      details:
        "ผลิตจากไม้พาร์ทิเคิลบอร์ดคุณภาพสูง (E1) ปิดผิวด้วยเมลามีนสีขาว สามารถกันความร้อนความชื้นได้อย่างดีเยี่ยม",
      price: 1990,
    },
    {
      id: 2,
      ...
      details:
        "ผลิตจากไม้พาร์ทิเคิลเกรดสูง (E1) ปิดผิวเมลามีน หรือปิดผิวฟอยล์",
      price: 2790,
    },
    {
      id: 3,
